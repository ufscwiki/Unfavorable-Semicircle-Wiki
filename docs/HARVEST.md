...
♐HARVEST is a video posted to the second youtube account on October 10, 2016. It was posted five days after the conclusion of the ♐[BROTHER](BROTHER) series and a day before the beginning of the ♐[SLIM](SLIM) series.
...
noise from the end of ♐[ZUFCHO](ZUFCHO).

The [Unknown Voice](Unknown_Voice) speaks the letter "B" (or
...
related to the ♐[DEPTH](DEPTH) composite, although the bottom
...
from the way it is reproduced in the composite on June 21st.
  ...
  - **See also ♐[GOLDEN](GOLDEN), which has a similar (though
...
* *further discussion in the wiki's [Astrology](Astrology) article*
