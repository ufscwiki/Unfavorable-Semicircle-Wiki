...
After the suspension of the original youtube channel, [garbled text](Google_Plus#G.2B_post_1) was discovered on the Google+
...
♐[EL](EL). Other series would follow, namely
♐[RIA](RIA), ♐[LEE](LEE),
♐[CAB](CAB), ♐[MUL](MUL), [an unnamed
series](April_10_twitter_series), ♐[NIL](NIL),
♐[DEPTH](DEPTH), ♐[POINT](POINT). There were
...
After the end of the ♐[POINT](POINT) series on February 13th,
2017 no further tweets were posted.

### A "strange reset"

On September 15, 2017 a video named ♐[RESET STRANGE YD](RESET_STRANGE_YD) was posted on youtube. Shortly after
...
(*see [November 25th tweet](November_25th_tweet) for more
information*.)

On December 6, 2017, the account began posting new videos in a short
series named ♐[FMI](FMI) and a standalone video named ♐[DDR
DONE](DDR_DONE). It was followed on December 9th by a "double
series" named ♐[SECOND](SECOND).
...
The [fourth G+ post](Google_Plus#G.2B_post_4) contained a
...
## Unusual/unique tweets
  ...
  - On March 18, 2016, ♐[REDLOC](REDLOC) was "announced"
