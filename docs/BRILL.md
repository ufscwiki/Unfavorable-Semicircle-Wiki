...
♐[BRILL B](BRILL_B), then began with numbered videos
counting up from ♐BRILL 0. (the last was ♐BRILL 29273.) The second
youtube account, after posting ♐[RELOCK](RELOCK), ♐[BRILL
49999](BRILL_49999) and ♐[N\* BRILL](N*_BRILL),
resumed from ♐BRILL 49999 (a "regular" BRILL video different than
♐[BRILL 49999](BRILL_49999)) and continued to ♐BRILL 50099.
...
*is ♐[N\* BRILL](N*_BRILL) a compilation of the individual
videos? Do the ♐[BRINE](BRINE) videos, which create a similar
...
* this could [connect them to the astrological sign of Pisces](Astrology).
* it also creates a connection to ♐[BRINE](BRINE), as brill live in saltwater.

### Hearthstone
Brill is the name of a town in the Warcraft fictional universe, also shared by [Hearthstone](Hearthstone).
